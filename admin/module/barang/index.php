<?php
$role = $_SESSION['admin']['role'] ?? 'view'; // ambil role user, default 'view'
                        ...
                        <?php if($role === 'view'){ ?>
                            <?php if($isi['stok'] <= 3){ ?>
                                <form method="POST" action="fungsi/edit/edit.php?stok=edit">
                                    ...
                                    <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo urlencode($isi['id_barang']);?>&csrf_token=<?php echo urlencode(csrf_get_token());?>" onclick="return confirm('Hapus Data barang ?');">
