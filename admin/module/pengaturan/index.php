...
<div class="card">
	<div class="card-body">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label for="">Minimum Stok Barang</label>
						<input type="number" class="form-control" name="min_stok" value="<?= htmlspecialchars($toko['min_stok'] ?? '3', ENT_QUOTES, 'UTF-8');?>"
									placeholder="Minimum Stok" min="1" required>
