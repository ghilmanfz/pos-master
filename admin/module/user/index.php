                            ...
                            <div class="control-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" style="border-radius:0px;" name="nama"
                                           value="<?= htmlspecialchars($hasil['nm_member'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                           required="required" />
                                </div>
                            </div>
                            ...
                            <div class="control-group mb-3">
                                ...
                                <div class="input-group">
                                    <select name="role" class="form-control" style="border-radius:0px;" required="required">
                                        ...
                                        <option value="owner" <?= ($hasil['role'] ?? '') === 'owner' ? 'selected' : '' ?>>View Only</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" style="border-radius:0px;" name="user"
                                           value="<?= htmlspecialchars($hasil['user'] ?? '', ENT_QUOTES, 'UTF-8');?>" />
                                </div>
                            </div>
                            <div class="control-group mb-3">
                                <label class="control-label" for="typeahead">Password Baru</label>
                                <div class="input-group">
                                    <input type="password" class="form-control" placeholder="Enter Your New Password" id="pass" name="pass"
                                           required="required" />
                                </div>
                            </div>
                            <input type="hidden" name="id"
                                   value="<?= htmlspecialchars($hasil['id_member'] ?? '', ENT_QUOTES, 'UTF-8');?>" required="required" />
                            <button type="submit" class="btn btn-primary" value="Tambah" name="proses">
