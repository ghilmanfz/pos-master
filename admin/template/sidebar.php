...
<?php 
    ...
    $role = $hasil_profil['role']; // ambil role dari member
?>
<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        ...
        <div id="collapseUser" class="collapse" aria-labelledby="headingUser" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="index.php?page=kelola_user/list_user">Kelola User</a>
            </div>
        </div>
    </li>
    <?php endif; ?>
    ...
    <!-- Nav Item - Transaksi -->
    <?php if($role === 'owner'): ?>
    <!-- Owner hanya bisa lihat Laporan Penjualan -->
    <li class="nav-item active">
    ...
    <?php else: ?>
    <!-- Admin dan Kasir bisa lihat semua menu transaksi -->
    <li class="nav-item active">
