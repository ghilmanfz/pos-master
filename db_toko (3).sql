...
(4, 'BR001', 10, 'Tabung Gas 3 Kg', '-', '18000', '20000', 'PCS', '8', '27 September 2025, 17:50', '27 September 2025, 17:54'),
(5, 'BR002', 10, 'Tabung LPG 5,5 kg', 'Bright gas', '45000', '50000', 'PCS', '3', '27 September 2025, 17:54', NULL),
...
(59, 'BR001', 1, '1', '20000', '30 April 2026, 11:06', '04-2026', 0, 0.00, 0.00, 20000.00, 180000.00, 160000.00),
(60, 'BR002', 1, '1', '50000', '30 April 2026, 11:22', '04-2026', 21, 2.00, 4000.00, 46000.00, 50000.00, 4000.00);
...
INSERT INTO `toko` (`id_toko`, `nama_toko`, `alamat_toko`, `tlp`, `nama_pemilik`, `api_fonte_token`, `api_fonte_phone`, `pesan_test`, `reminder_aktif`, `reminder_terakhir`, `min_stok`) VALUES
(1, 'Agen Gas Bang Usup', 'Jl H Sarmah No 55, Pondok Kacang Timur, Pondok Aren', '088888888', 'Usup', 'rKEAo8bU5yCTKMqYKPed', '', 'Sedang Testing', 'ya', NULL, 3);
...
--
ALTER TABLE `customer_barang`
  MODIFY `id_cb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
